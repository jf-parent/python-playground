...
static int __pyx_f_8solution_solution(int __pyx_v_n, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_answer;
  int __pyx_v_index;
  int __pyx_r;
 ...
 * 
 */
    __pyx_t_5 = ((__Pyx_mod_long(__pyx_v_index, 3) == 0) != 0);
    if (!__pyx_t_5) {
    } else {
      __pyx_t_4 = __pyx_t_5;
      goto __pyx_L6_bool_binop_done;
    }
    __pyx_t_5 = ((__Pyx_mod_long(__pyx_v_index, 5) == 0) != 0);
    __pyx_t_4 = __pyx_t_5;
 ...
 *     return answer
 */
      __pyx_v_answer = (__pyx_v_answer + __pyx_v_index);
...
static PyObject *__pyx_pf_8solution_solution(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_n) {
  ...
  __pyx_t_1 = __Pyx_PyInt_From_int(__pyx_f_8solution_solution(__pyx_v_n, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 2, __pyx_L1_error)
