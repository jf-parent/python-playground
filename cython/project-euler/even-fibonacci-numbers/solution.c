...
static int __pyx_f_8solution_solution(int, int __pyx_skip_dispatch); /*proto*/
...
static PyObject *__pyx_pf_8solution_solution(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_limit); /* proto */
/* Late includes */
...
static PyObject *__pyx_pw_8solution_1solution(PyObject *__pyx_self, PyObject *__pyx_arg_limit); /*proto*/
static int __pyx_f_8solution_solution(int __pyx_v_limit, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_last_fib;
  int __pyx_v_cur_fib;
  int __pyx_v_answer;
  int __pyx_v_next_fib;
  int __pyx_r;
 ...
 */
  while (1) {
    __pyx_t_1 = ((__pyx_v_cur_fib < __pyx_v_limit) != 0);
    if (!__pyx_t_1) break;
 ...
 * 
 */
    __pyx_t_1 = ((__Pyx_mod_long(__pyx_v_cur_fib, 2) == 0) != 0);
    if (__pyx_t_1) {
 ...
 */
      __pyx_v_answer = (__pyx_v_answer + __pyx_v_cur_fib);
 ...
 *         cur_fib = next_fib
 */
    __pyx_v_next_fib = (__pyx_v_cur_fib + __pyx_v_last_fib);
 ...
 * 
 */
    __pyx_v_last_fib = __pyx_v_cur_fib;
 ...
 *     return answer
 */
    __pyx_v_cur_fib = __pyx_v_next_fib;
  }
...
/* Python wrapper */
static PyObject *__pyx_pw_8solution_1solution(PyObject *__pyx_self, PyObject *__pyx_arg_limit); /*proto*/
static PyObject *__pyx_pw_8solution_1solution(PyObject *__pyx_self, PyObject *__pyx_arg_limit) {
  int __pyx_v_limit;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("solution (wrapper)", 0);
  assert(__pyx_arg_limit); {
    __pyx_v_limit = __Pyx_PyInt_As_int(__pyx_arg_limit); if (unlikely((__pyx_v_limit == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 2, __pyx_L3_error)
  }
  ...
  __pyx_r = __pyx_pf_8solution_solution(__pyx_self, ((int)__pyx_v_limit));
...
static PyObject *__pyx_pf_8solution_solution(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_limit) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("solution", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __Pyx_PyInt_From_int(__pyx_f_8solution_solution(__pyx_v_limit, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 2, __pyx_L1_error)
