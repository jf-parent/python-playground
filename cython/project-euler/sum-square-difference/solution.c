...
static PyObject *__pyx_f_8solution_solution(int __pyx_skip_dispatch); /*proto*/
...
static PyObject *__pyx_f_8solution_solution(CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_sum_of_squares_100;
  int __pyx_v_square_of_sum_100;
  int __pyx_v_i;
 ...
 */
    __pyx_v_sum_of_squares_100 = (__pyx_v_sum_of_squares_100 + (__pyx_v_i * __pyx_v_i));
 ...
 * 
 */
    __pyx_v_square_of_sum_100 = (__pyx_v_square_of_sum_100 + __pyx_v_i);
  }
 ...
 */
  __pyx_v_square_of_sum_100 = (__pyx_v_square_of_sum_100 * __pyx_v_square_of_sum_100);
 ...
 */
  ...
  __pyx_t_2 = __Pyx_PyInt_From_int((__pyx_v_square_of_sum_100 - __pyx_v_sum_of_squares_100)); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 11, __pyx_L1_error)
...
static PyObject *__pyx_pf_8solution_solution(CYTHON_UNUSED PyObject *__pyx_self) {
  ...
  __Pyx_RefNannySetupContext("solution", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_f_8solution_solution(0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 2, __pyx_L1_error)
